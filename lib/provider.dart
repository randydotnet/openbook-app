...
class OpenbookProviderState extends State<OpenbookProvider> {
  ...
  PostCommentReportsApiService postCommentReportsApiService = PostCommentReportsApiService();
  ...
  void initState() {
    ...
    userService.setPostCommentReportsApiService(postCommentReportsApiService);
    ...
    postCommentReportsApiService.setHttpieService(httpService);
    postCommentReportsApiService.setStringTemplateService(stringTemplateService);
  ...
  void initAsyncState() async {
    ...
    postCommentReportsApiService.setApiURL(environment.apiUrl);
